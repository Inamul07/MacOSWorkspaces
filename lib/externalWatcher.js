...
export class ExternalChangeWatcher {
    ...
    destroy() {
        ...
        console.log('[macos-workspaces] external change watcher stopped');
    }
    ...
    _warnAboutConflicts() {
        ...
        for (const [uuid, reason] of this.conflicts) {
            console.warn(`[macos-workspaces] '${uuid}' is also enabled and ${reason}. ` +
    ...
    _onActiveWorkspaceChanged() {
        ...
        console.log('[macos-workspaces] workspace changed to ' +
    ...
    _rebuildAfterMonitorChange() {
        ...
        console.log('[macos-workspaces] monitors changed — every display reset to ' +
            `workspace ${active}`);
    }
